...
class SMCWithMLLuxAlgo5m(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[long_mask & ~dataframe['in_bullish_ob'] & ~dataframe['in_bull_breaker'] & ~dataframe['in_bullish_fvg'] & ~dataframe['in_bull_fvg_breaker'], 'enter_tag'] = 'NoZone'
        ...
        dataframe.loc[short_mask & ~dataframe['in_bearish_ob'] & ~dataframe['in_bear_breaker'] & ~dataframe['in_bearish_fvg'] & ~dataframe['in_bear_fvg_breaker'], 'enter_tag'] = 'NoZone'
